...
для дальнейшего dispatch через `/tech-debt-review`.
...
review во время следующего `/tech-debt-review` — item тихо застревает в backlog'е.

## Suggested workflow для review

Run `/tech-debt-review`; для этого item:
