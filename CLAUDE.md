...
- `docs/superpowers/plans/` — phase plans (Phase 1.0, 1.0.5, 1.0.6, 1.1.0 закрыты; Phase 1.1.1 (interop_calls) — следующий sub-phase).
- `docs/roadmap.md` — live index отложенной работы (Phase 1.1 scope зафиксирован).
